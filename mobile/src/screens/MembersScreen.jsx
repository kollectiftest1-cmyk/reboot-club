...
export function MembersScreen() {
    ...
    const load = useCallback(() => api("/users/").then(data => setMembers(data.results)), []);
...
const styles = StyleSheet.create({
    ...
    list: { borderWidth: 1, borderColor: colors.line, borderRadius: radius.md, overflow: "hidden", backgroundColor: colors.white }, member: { minHeight: 78, flexDirection: "row", alignItems: "center", gap: spacing.sm, padding: spacing.md, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: colors.line }, avatar: { width: 42, height: 42, borderRadius: 21, alignItems: "center", justifyContent: "center", backgroundColor: colors.mint }, initial: { fontFamily: font.bold, color: colors.forest, fontSize: 16 }, copy: { flex: 1 }, nameRow: { flexDirection: "row", alignItems: "center", gap: spacing.xs }, name: { fontFamily: font.bold, color: colors.ink, fontSize: 12 }, phone: { fontFamily: font.medium, color: colors.ink, fontSize: 10, marginTop: 3 }, role: { fontFamily: font.medium, color: colors.muted, fontSize: 9, marginTop: 2 }, action: { width: 34, height: 34, alignItems: "center", justifyContent: "center", borderRadius: radius.md, backgroundColor: colors.paper },
});

...
from .models import AuditLog, BorrowerInstallment, Club, ClubMessage, ClubRateTier, Deposit, Dispute, EconomicActivity, Installment, Invitation, KYCApplication, Loan, LoanBorrower, LoanFunding, LoanPurpose, Membership, Notification, OTPChallenge, PlatformSettings, Repayment, User, Withdrawal
...
admin.site.register(BorrowerInstallment)
